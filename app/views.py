...
class ProductView(View):
    def get(self,request):
        ...
        return render(request,'app/home.html',{'Men':Men,'Women':Women})
...
def RecommendProduct(product_name):
    ...
    products_prob = pd.read_csv("C:/Users/sandp/Data Science Project/MiseEnKitchen/products_prob.csv")
    #Add item to basket
    basket = p_array
...
# def predict(product,request):
#     l=recommend(product, 3)
#     return render(request,'app/productdetail.html', ob1=l[0], ob2=l[1], ob3=l[2])
